...
public class HibernateHelper extends Generic
{
    ...
    public static boolean Operation(Route d,String crud)
    {
        try
        {
            ...
            {
                logContent("Inside Ins_Upd",LoggerFactory.INFO , null);
            ...
            t.commit();
            logContent("Transaction commited ",LoggerFactory.INFO , null);
        }
        catch(Exception e)
        {
            e.printStackTrace();
            ...
            {
                t.rollback();
                logContent("Transaction rollbacked",LoggerFactory.DEBUG , null);
            }
            result= false;
        }
        finally
        ...
        logContent("Object saved ..",LoggerFactory.DEBUG , null);
        return result;
    }
    ...
    public static boolean delete(Route d,String crud) // Query method to delete routes
    {
        try
        {   
            logContent(d.toString(),LoggerFactory.DEBUG , null);   
            ...
            t.commit();
            logContent("Transaction commited ",LoggerFactory.DEBUG , null);
            logContent("Object deleted ..",LoggerFactory.DEBUG , null);
        }
        catch(Exception e)
        {
            e.printStackTrace();
