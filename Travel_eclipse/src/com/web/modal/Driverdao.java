...
public class Driverdao extends Generic{
    ...
    {
        logContent(INSERT_DRIVER,LoggerFactory.DEBUG , null);
    ...
    {
        logContent(SELECT_BY_ID,LoggerFactory.DEBUG , null);
    ...
    public boolean deleteDriver(String id)throws SQLException
    {
        ...
        logContent(ps,LoggerFactory.DEBUG , null);
        rowsAffected = ps.executeUpdate() > 0;
        logContent("Deleted driver"+rowsAffected,LoggerFactory.DEBUG , null);
        return rowsAffected;
    }
