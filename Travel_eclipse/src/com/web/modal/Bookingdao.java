...
public class Bookingdao extends Generic{
    ...
    public int insertBooking(Booking user) 
    {
        ...
        try {			
            ...
            {
                result = rs.getInt(1);
                logContent("Booking No ::"+result,LoggerFactory.DEBUG , null);
            }
    ...
    public Booking selectBooking(int id) {
        logContent(SELECT_USER_BY_ID,LoggerFactory.DEBUG , null);	
    ...
    public boolean deleteBooking(int id) 
    {
        ...
        logContent(DELETE_USERS_SQL,LoggerFactory.DEBUG , null);
        try {
    ...
    public boolean bookingCheck(Booking user, Customer c) {
        ...
        try {
            ...
            logContent(CheckQuery(user, c),LoggerFactory.DEBUG , null);
