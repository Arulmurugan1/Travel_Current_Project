...
public class Vehicledao extends Generic{
    ...
    {
        logContent(SELECT_BY_NO,LoggerFactory.DEBUG , null);
    ...
    public boolean deleteVehicle(String no) throws SQLException
    {
        ...
        logContent(DELETE_VEHICLE,LoggerFactory.DEBUG , null);
        ...
        logContent("Deleted Vehicle "+rowDeleted,LoggerFactory.DEBUG , null);
        return rowDeleted;
    }
