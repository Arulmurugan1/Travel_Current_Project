...
{
	String user_id, image_name, image_path, uploaded_by ,type,objectUrl;
	int size ;
	...
	public String toString() {
		return "UserImage [user_id=" + user_id + ", image_name=" + image_name + ", image_path=" + image_path
				+ ", uploaded_by=" + uploaded_by + ", type=" + type + ", objectUrl=" + objectUrl + ", size=" + size
