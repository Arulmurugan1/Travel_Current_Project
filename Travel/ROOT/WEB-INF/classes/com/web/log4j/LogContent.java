...
public class LogContent extends CommonFactory  
{
	...
	{
		LoggerFactory.displayDiffLogLevels(isNull(message), logLevel, exception,Generic.LogObject);
	}
	...
	{
		LoggerFactory.displayDiffLogLevels(isNull(message), logLevel, null,Generic.LogObject);
	}
